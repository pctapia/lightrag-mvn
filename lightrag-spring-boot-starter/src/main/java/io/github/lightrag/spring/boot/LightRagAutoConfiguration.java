...
public class LightRagAutoConfiguration {
    ...
    private static io.github.lightrag.storage.mysql.MySqlStorageConfig mySqlConfig(LightRagProperties properties) {
    ...
    private static io.github.lightrag.storage.milvus.MilvusVectorConfig milvusConfig(LightRagProperties properties) {
